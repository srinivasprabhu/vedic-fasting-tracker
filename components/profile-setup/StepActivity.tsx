...
const OPTIONS: { id: ActivityLevel; emoji: string; name: string; desc: string; example: string }[] = [
  { id: 'sedentary',         emoji: '🪑', name: 'Sedentary',          desc: 'Desk job, little movement',          example: 'Office worker, mostly sitting' },
  { id: 'lightly_active',    emoji: '🚶', name: 'Lightly active',     desc: 'Light exercise 1–3 days/week',       example: 'Walking, light yoga' },
  { id: 'moderately_active', emoji: '🏃', name: 'Moderately active',  desc: 'Moderate exercise 3–5 days/week',    example: 'Gym, cycling, swimming' },
  { id: 'very_active',       emoji: '⚡', name: 'Very active',        desc: 'Hard exercise 6–7 days/week',        example: 'Athletes, manual labour' },
];
          ...
          return (
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={[s.cardExample, { color: isDark ? 'rgba(200,135,42,.35)' : 'rgba(160,104,32,.45)' }]}>{opt.example}</Text>
              </View>
              {sel && (
...
const s = StyleSheet.create({
  ...
  cardDesc:    { fontFamily: FONTS.bodyRegular, fontSize: 12, lineHeight: 17, marginBottom: 2 } as TextStyle,
  cardExample: { fontFamily: FONTS.bodyRegular, fontSize: 11, lineHeight: 15, fontStyle: 'italic' as const } as TextStyle,
