...
export default function CalendarScreen() {
  ...
  const prevMonth = useCallback(() => {
    Animated.sequence([
      Animated.timing(monthAnim, { toValue: 0, duration: 150, useNativeDriver: true }),
      Animated.timing(monthAnim, { toValue: 1, duration: 150, useNativeDriver: true }),
    ]).start();
    if (currentMonth === 0) {
      setCurrentMonth(11);
